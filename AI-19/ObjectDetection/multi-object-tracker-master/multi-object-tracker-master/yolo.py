...
st.title("Object Detection using AI")
...
webcam = st.slider("Webcam",  0, 3, 0)
x = "The webcam is "+ str(webcam)
st.title(x)
run = st.button("Do you want to run")
if run:
    video_src = webcam
    ...
    while (True):
        ...
        st.image(image, caption='LOL', use_column_width=True)
...
st.sidebar.title("Objects we can detect")
names = '/Users/kunal/Documents/AI-19/ObjectDetection/multi-object-tracker-master/multi-object-tracker-master/names.txt'
f = open(names, 'r+')
